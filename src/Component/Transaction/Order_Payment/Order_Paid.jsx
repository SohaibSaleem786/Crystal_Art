...
function Order_Paid() {
  ...
  <PathHead pageName="File > Order Payment > Order Paid"  screen='Get_Item' pageLink="/Order_Payment"/>
    ...
    <div className="col-6">
      ...
      <Form.Group controlId="description" style={{ display: 'flex', alignItems: 'center',marginTop:'-2%' }}>
        <Form.Label style={{ marginRight: '10px' }}>Payment Id:</Form.Label>
        <Form.Control
          type="text"
          placeholder="Id"
          name="FCtgDscc"
      ...
      <Form.Group controlId="description" style={{ display: 'flex', alignItems: 'center' ,marginTop:'-2%'}}>
        <Form.Label style={{ marginRight: '10px' ,marginLeft:'45px' }}>Date:</Form.Label>
        <Form.Control
          type="text"
          placeholder="Date"
          name="Date"
      ...
      <Form.Group controlId="description" style={{ display: 'flex', alignItems: 'center',marginTop:'-2%' }}>
        <Form.Label style={{ marginRight: '10px',marginLeft:'27px' }}>Vender:</Form.Label>
        <Form.Control
          type="text"
          placeholder="Vender"
          name="Vender"
      ...
      <Form.Group controlId="description" style={{ display: 'flex', alignItems: 'center',marginTop:'-2%' }}>
        <Form.Label style={{ marginRight: '10px' ,marginLeft:'3px'}}>Transac Id:</Form.Label>
        <Form.Control
          type="text"
      ...
      <Form.Group controlId="status" style={{ display: 'flex', alignItems: 'center' ,marginTop:'-1%'}}>
        <Form.Label style={{ marginRight: '13px', marginLeft: '37px', textAlign: 'right' }}>Mode:</Form.Label>
        <Form.Control
          as="select"
          name="FCtgStss"
      ...
      <Form.Group controlId="description" style={{ display: 'flex', alignItems: 'center',marginTop:'-1%' }}>
        <Form.Label style={{ marginRight: '10px' ,marginLeft:'23px'}}>Amount:</Form.Label>
        <Form.Control
          type="text"
          placeholder="Amount "
          name="Amount"
    ...
    <div className="col-6">
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '30px' }}>
        <div style={{ flex: 1, marginRight: '-20px', textAlign: 'center' }}>
          <label htmlFor="pic" style={{ display: 'block', marginBottom: '10px' }}>Payment Pic: </label>
