    ...
    fetch(`${apiLinks}/OrderList.php`)
      ...
      .then((apiData) => {
        ...
        const columns = [
          ...
          { label: "Status Date", field: "tedtdat", sort: "asc" },
...
return (
  <>
    <div style={{
      ...
      <PathHead pageName="Transaction > Order Tracking" screen='Get_Item' pageLink="/MainPage"/>
      ...
      >
        ...
        <option value="Delivered">Order Delivered</option>
              ...
              <Col xs={12} sm={3} md={3} lg={3} xl={{ span: 2 ,offset: 8 }}>
    <Form.Control
      type="text"
...
<td>{formatDate(row.torddat) || ''}</td>
  ...
  // If tordtim is falsy (null, undefined, 0, etc.), the button is disabled
  <>
    <td>
      <div>
        <Button
          className="btn btn-primary"
          style={{
            backgroundColor: primaryColor, // Set the background color for disabled state
            fontSize: '11px',
            color: secondaryColor,
            width: '80%',
            height: '26px',
