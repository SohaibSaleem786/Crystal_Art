...
return (
  <>
    <div style={{
      ...
      <PathHead pageName="Transaction > Order List" />
      ...
      {Object.keys(row).map((key, columnIndex) => {
        if (columnIndex !== 7) { // Skip rendering the 7th column
          return (
            <td
              ...
              style={{
                textAlign:
                  columnIndex === 3 || columnIndex === 5 ? "left" : columnIndex === 6 ? "right" : "center",
                width: columnIndex === 5 ? "30%" : "auto",
              }}
            >
        ...
        <td>
          <div>
            ...
            <Link to={`/Cart_Item/${row.id}`} onClick={() => handleLinkClick(row.id)}>
              <img
                src={Edit}
                alt="Login"
